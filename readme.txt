...
WP Link Robot is an advanced Link Directory managment system with backlink checking and SEO status information about your partners' sites.
...
There aren't any special requirements for WP Link Robot to work, and you don't need to install any additional plugins.
   ...
   3. Go into Wordpress plugins setup in Wordpress administration interface and activate WP Link Robot plugin.
   4. Go into Wordpress Tools menu, open Link Robot, and configure your site details in the Settings tab.
   5. To show the list of links sorted in categories, just place the shortcode &lt;!-- wp_link_robot_genlinks --&gt; into the page where you wish the list of links to appear, type the page slug in the settings tab under Main directory options
