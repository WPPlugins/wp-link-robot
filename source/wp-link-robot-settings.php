...
<div class="wrap" style="clear:left"><br />
  ...
  <input name="pageslug" type="text" id="mname" value="<?php echo($s_pageslug); ?>" size="45" /> e.g. &quot;links&quot;, if using permalinks, update your permalink structure after changing this!
  <br /><br />
